...
public class DigraphAL extends Digraph {
    ...
    public DigraphAL(int size) {
        ...
        for(int i = 0; i < size;i++){
            ...
            }//El primer número de la pareja es el destination y el segundo es el peso del grafo weight
        }
    }
    ...
    public void addArc(int source, int destination, int weight) {
        grafoArregloLista.get(source).remove(destination);// Remuevo la pareja (0,0) que estaba en esta posición
        grafoArregloLista.get(source).add(destination,new Pair(destination,weight)); // Remplazo la pareja (0,0) con la nueva entrante
    }
